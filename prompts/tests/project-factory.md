...
5. Manager polls progress with `check_task` and completes each child with `complete_task`.
6. When all children are complete, manager calls `complete_project` and spawns the next project.
